...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		...
		if (auto.match('bot')){
        client.sendMessage(from, 'iya, ada apa kak. tekan  ${prefix}menu  untuk melihat menu ','ada masalah apa bro, tekan  ${prefix}menu  untuk melihat menu', text, { quoted: mek })
		}
	        /*****************END SCURITY FEATURE ********/
		...
		case 'oanime':
				...
				case 'kurumi':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=tokisaki%20kurumi`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'kurumi chann '})
					} catch (e) {
					...
					case 'shinobu':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/shinobu?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'Shinobu chann '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					case 'megumin':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/megumin?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'Megumin chann '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
				...
				case 'sagiri':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/sagiri?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'sagiri chann '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					case 'kaneki':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=kaneki%20ken`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'Kaneki ken !!! '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=miku%20nakano`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'Miku chann'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=yotsuba%20nakano`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'Yotsuba chann'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=ichika%20nakano`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'Ichika chann '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=nino%20nakank`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'Nino chann '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=itsuki%20nakano`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'Itsuki chann '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=astolfo%20fgo`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'Hmm... wangyy wangyy '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=chitoge%20kirisaki`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'chitoge kirisaki chann '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=inugami%20korone`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'wangyy wangyy'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=venti%20genshin`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'wangyy wangyy '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=ainz%20ooal%20gown`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: '*SASUGA AINZ SAMA* '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=albedo%20overlord`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'ALBEDO SAMA '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/pinterest?apikey=azka25&query=felix%20argyle`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'hmm.. wangyy wangyy '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
		...
		case 'ecchi':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/nsfw/ecchi?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'hmm... wangyy wangyy'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
					...
					case 'hololewd':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/nsfw/hololewd?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'hmm. wangyy wangyy '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
				 ...
				 if (!isNsfw) return reply(ind.nsfwoff())
				    try {
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'RANDOM NSFW BLOWJOB'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply(' *ERROR* ')
					}
				 ...
				 if (!isNsfw) return reply(ind.nsfwoff())
				    try {
						...
						buffer = await getBuffer(res.result)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Hmm.. Saya mencium bau-bau ghey !'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply(' *ERROR* ')
					}
					...
					case 'nsfwyuri':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random2/yuri?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'HMM... WANGYY WANGYY '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
					...
					case 'nsfwyaoi':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/nsfw/yaoi?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'HMM... BAU-BAU GHEY ! '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/nsfw/ahegao?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'RANDOM AHEGAO ANIME '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random2/lewd?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'RANDOM LEWD ANIME '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random2/femdom?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'RANDOM FEMDOM ANIME '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
			...
			case 'neonime':
                     ...
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random2/wallpaper?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'RANDOM WALLPAPER ANIME '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
             ...
             case 'wpanime2':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/wallnime?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'RANDOM WALLPAPER ANIME '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
           ...
           case 'waifu2':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/waifu?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'CINTAI WAIFUMU '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					case 'elf':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/elf?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'RANDOM ELF'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
           ...
           case 'fanart':
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/art?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'RANDOM FANART ANIME '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
				...
				if (!isGroup) return reply(ind.groupo())
					ranp = getRandom('.gif')
					rano = getRandom('.webp')
					anu = await fetchJson('https://lolhuman.herokuapp.com/api/random2/baka?apikey=azka25', {method: 'get'})
				...
				if (!isGroup) return reply(ind.groupo())
					ranp = getRandom('.gif')
					rano = getRandom('.webp')
					anu = await fetchJson('https://lolhuman.herokuapp.com/api/random2/poke?apikey=azka25', {method: 'get'})
					if (anu.error) return reply(anu.error)
					exec(`wget ${anu.result} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						fs.unlinkSync(ranp)
						if (err) return reply(ind.stikga())
				...
				if (!isGroup) return reply(ind.groupo())
					ranp = getRandom('.gif')
					rano = getRandom('.webp')
					anu = await fetchJson('https://lolhuman.herokuapp.com/api/random2/smug?apikey=azka25', {method: 'get'})
					if (anu.error) return reply(anu.error)
					exec(`wget ${anu.result} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						fs.unlinkSync(ranp)
						if (err) return reply(ind.stikga())
				...
				if (!isGroup) return reply(ind.groupo())
					ranp = getRandom('.gif')
					rano = getRandom('.webp')
					anu = await fetchJson('https://lolhuman.herokuapp.com/api/random2/tickle?apikey=azka25', {method: 'get'})
					if (anu.error) return reply(anu.error)
					exec(`wget ${anu.result} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						fs.unlinkSync(ranp)
						if (err) return reply(ind.stikga())
					...
					gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/loli?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'DASAR LOLICON ! '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					case 'shota':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/shota?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'DASAR SHOTACON !'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					case 'meme':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/meme?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'RANDOM MEME'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
...
━━━⊱  ⸨ *AZKABOT* ⸩  ⊰━━━`
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					reply(ind.wait)
					anu = await fetchJson(`https://lolhuman.herokuapp.com/api/ytsearch?apikey=azka25&query=${body.slice(10)}`, {method: 'get'})
					if (anu.error) return reply(anu.error)
					teks = '=================\n'
            ...
            case 'bitly':
               ...
               client.updatePresence(from, Presence.composing) 
				...
				if (!isGroup) return reply(ind.groupo())
				    try {
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'CINTAI HUSBUMU'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
					...
					case 'husbu2':
                     gatauda = body.slice(6)
                                       ...
                                       reply(ind.wait)
				    try {
						res = await fetchJson(`https://lolhuman.herokuapp.com/api/random/husbu?apikey=azka25`, {method: 'get'})
						bufferxx = await getBuffer(res.result)
						client.sendMessage(from, bufferxx, image, {quoted: mek, caption: 'CINTAI HUSBUMU '})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('❌ *ERROR* ❌')
					}
               ...
               if (data.error) return reply(data.error)
				...
				if (!isGroup) return reply(ind.groupo())
					...
					anu = await fetchJson(`https://lolhuman.herokuapp.com/api/ytvideo?apikey=aaaasu&url=${args[0]}`, {method: 'get'})
					if (anu.error) return reply(anu.error)
